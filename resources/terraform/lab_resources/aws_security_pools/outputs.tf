...
#  value = module.aws_eu_west_1_api_fw_pool.ssh_access
#}

#output "aws_ec2_public_ip1" {
#  value = module.aws_eu_west_1_api_fw_pool.aws_eip_public_ip
#}
...
#output "vpc1_id" {
#  value = module.aws_eu_west_1_api_fw_pool.aws_vpc_id
#}
